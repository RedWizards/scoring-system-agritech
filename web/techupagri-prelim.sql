...
--
-- Host: localhost
-- Generation Time: Aug 23, 2018 at 10:57 AM
...
(2, 1, 'Execution of Theme', 30, 'The technology is able to express the theme â€œAGRITECHâ€'),
(3, 1, 'Innovation', 25, 'Was it able to exhibit its technical soundness (potential), and demonstrate how it was developed and the bases for its conceptualization.'),
(4, 1, 'Impact', 25, 'The technology can demonstrate the potential for impact and a high rate of success for effectiveness.'),
(5, 1, 'Viability', 20, 'The solution is able to demonstrate feasibility of success and future replication or upscaling.');
...
(1, 'UHAC Tech UP Agri', 'Unionbank', 'Another project of the Bank to find the most creative and innovative solutions in the digital world.', '2017-07-16 00:00:00');
